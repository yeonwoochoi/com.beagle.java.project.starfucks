...
public class Receipt {
    ...
    private int[] order_count_list;
    private int total;

    public Receipt(int order_number, String[] order_name_list, int[] order_price_list, int[] order_count_list) {
    ...
    public int[] getOrder_count_list() {return this.order_count_list; }
    ...
    public void setOrder_count_list(int[] order_count_list) {
        this.order_count_list = order_count_list;
    }

    public void setTotal() {
        int[] price_list = getOrder_price_list();
        int[] count_list = getOrder_count_list();
        int total = 0;
        for (int i = 0; i < price_list.length; i++) {
            total += (price_list[i] * count_list[i]);
        }
        this.total = total;
    }
